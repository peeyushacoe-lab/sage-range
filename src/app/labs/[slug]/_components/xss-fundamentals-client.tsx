  ...
  return (
    <div className="space-y-6">
      ...
      <TaskShell number={1} title="Reflected XSS" unlocked completed={done("task_1")}>
        ...
        {done("task_1") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — reflected XSS executes in the victim&apos;s browser. Flag: {revealed.task_1 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={2} title="Stored XSS" unlocked={done("task_1")} completed={done("task_2")}>
        ...
        {done("task_2") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — <code>document.cookie</code> exfiltrates session cookies. Flag: {revealed.task_2 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={3} title="CSP Bypass" unlocked={done("task_2")} completed={done("task_3")}>
        ...
        {done("task_3") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — jsdelivr.net is trusted by the CSP and can host attacker-controlled scripts. Flag: {revealed.task_3 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
