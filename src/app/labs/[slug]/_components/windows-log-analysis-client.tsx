  ...
  return (
    <div className="space-y-6">
      ...
      <TaskShell number={1} title="Detect Failed Logins" unlocked completed={done("task_1")}>
        ...
        {done("task_1") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — 847+ failures against one account = brute force. Flag: {revealed.task_1 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={2} title="Trace Lateral Movement" unlocked={done("task_1")} completed={done("task_2")}>
        ...
        {done("task_2") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — WMI lateral movement via WmiPrvSE.exe on port 135. Flag: {revealed.task_2 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={3} title="Find Data Exfiltration" unlocked={done("task_2")} completed={done("task_3")}>
        ...
        {done("task_3") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — 2.4 GB exfiltrated to the C2. Flag: {revealed.task_3 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
