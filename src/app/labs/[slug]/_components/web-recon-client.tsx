  ...
  return (
    <div className="space-y-6">
      ...
      <TaskShell number={1} title="robots.txt Discovery" unlocked completed={done("task_1")}>
        ...
        {done("task_1") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — /admin-panel-9f3a2/ was disclosed. Flag: {revealed.task_1 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={2} title="Directory Brute Force" unlocked={done("task_1")} completed={done("task_2")}>
        ...
        {done("task_2") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — an exposed .git/config leaks full source history. Flag: {revealed.task_2 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
      ...
      <TaskShell number={3} title="Certificate Transparency" unlocked={done("task_2")} completed={done("task_3")}>
        ...
        {done("task_3") && (
          <p className="text-sm font-mono text-sage-400">
            Correct — admin-staging combines admin access with reduced security controls. Flag: {revealed.task_3 ?? "SAGE{…}"}
          </p>
        )}
      </TaskShell>
