  ...
  return (
    <div className="space-y-6">
      <TaskShell number={1} title="Spot the Missing Tell" unlocked completed={done("task_1")}>
        ...
        {done("task_1") && (
          <p className="text-sm font-mono text-sage-400">Correct — the email has no grammar or spelling mistakes at all, unlike classic phishing. Flag: {revealed.task_1 ?? "SAGE{…}"}</p>
        )}
      </TaskShell>
      ...
      <TaskShell number={2} title="Shift Your Detection Focus" unlocked={done("task_1")} completed={done("task_2")}>
        ...
        {done("task_2") && (
          <p className="text-sm font-mono text-sage-400">Correct — domain mismatch, urgency, and payment requests together are the real signal now. Flag: {revealed.task_2 ?? "SAGE{…}"}</p>
        )}
      </TaskShell>
