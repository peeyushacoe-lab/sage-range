    ...
    <div className="min-h-screen bg-surface-0 text-white">
      ...
      <main>
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <p className="text-ink-2 text-sm mb-10">
          ...
          <div className="space-y-10 text-sm leading-relaxed text-ink-2">
            <section>
              ...
              <p className="text-ink-2 mb-3">We collect the following categories of data when you use Sage Vault:</p>
            ...
            <section>
              ...
              <p className="text-ink-2 mb-3">We do not sell your personal data. We share data only with:</p>
              <ul className="space-y-2 text-ink-2">
              ...
              <p className="text-ink-2 mt-3">Recruiters with an Enterprise plan can view your public simulation profile only if your profile is set to visible. Simulation scores and certificates are not shared without your action.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-2 mb-3">Under GDPR and UK data protection law, you have the right to:</p>
              ...
              <p className="text-ink-2 mt-3">
                ...
                <a href="mailto:support@cybersage.uk" className="text-ok hover:underline">support@cybersage.uk</a>.
            ...
            <section>
              ...
              <p className="text-ink-2">We use the following cookies:</p>
              <ul className="space-y-2 text-ink-2 mt-3">
                <li><span className="font-mono text-xs text-ink-2">next-auth.session-token</span> — Authentication session. Required for login.</li>
                <li><span className="font-mono text-xs text-ink-2">sage_onboarded</span> — Whether you&apos;ve completed onboarding. httpOnly, expires in 1 year.</li>
                <li><span className="font-mono text-xs text-ink-2">sage_role</span> — Your current role for edge routing. httpOnly, expires in 1 year.</li>
              </ul>
              <p className="text-ink-2 mt-3">We do not use advertising cookies or third-party tracking.</p>
            </section>
          ...
          <div className="mt-12 flex gap-4 text-xs text-ink-3">
            ...
            <Link href="/legal/cookies" className="hover:text-ink-2">Cookie Policy</Link>
