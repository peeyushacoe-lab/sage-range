...
export default async function PricingPage() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-8 rounded-xl border border-edge p-5">
        <p className="text-xs font-semibold text-ink-2 mb-3 uppercase tracking-wider">How it works</p>
        <ul className="space-y-2 text-xs text-ink-3">
          <li>• Set a price to <span className="text-ink-2">$0</span> to make that plan free — no payment collected.</li>
